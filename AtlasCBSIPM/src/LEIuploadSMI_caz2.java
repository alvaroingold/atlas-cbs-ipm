...
//
//public class LEIuploadSMI extends HttpServlet {
//
//
...
//	    String line = "";
//	    while ((line = bis.readLine()) != null && mols < 1000) {
...
//				continue;
//			}
//			type=2; /* We generate random Ki from uM to pM ranges */
//			exponent = genRnd.nextInt(6);
//			value = genRnd.nextDouble() * Math.pow(10.0,(Double.parseDouble( Integer.toString(exponent))));
//
//			if( type < 0 || value == 0.0)
//			{
//	                        salida.print("{success: false},");
...
//		        double psa = 0.0;
//		        double mass = 0.0;
//			  double rconst = 0.00198;  // R-const Kilocal
//                    double tkelvin = 300.0; // Temperature for DeltaG
//		        int nhea = 0;
//		        int npol = 0;
//		        int natoms = 0;
//		        int molid = -1;
...
//
//		        double bei, sei, nsei, nbei, nbei2, mbei, lep;
//		        double pk = 0.0;
//			  double lep = 0.0;
//                    double pkh = 0.0;
...
//		       }
//
//			 if( bind.existLEI(id_pharmacology,8) < 0)
//		       {
//		                   stmt = conn.prepareStatement("INSERT INTO LEI(ID_PHARMACOLOGY,ID_TYPE,VALUE) VALUES (?,8,?)");
//		                   stmt.setInt(1, id_pharmacology);
//		                   stmt.setDouble(2, lep);
//		                   stmt.executeUpdate();
//		       }
//
//		}catch (Exception e){
