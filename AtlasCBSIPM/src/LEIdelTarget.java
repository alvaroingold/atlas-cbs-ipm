...
public class LEIdelTarget extends HttpServlet {
	    ...
	    if( aut != null && Integer.parseInt(iduser_session) >= 0 && param != null && param != "")	
	    {
			...
			int id_target = -1;
		        ...
		        int id_default_org = -1;
                        ...
                        st2 = conn.prepareStatement("INSERT INTO TARGORG (ID_TARGET, ID_ORGANISM) VALUES (?,?);", Statement.RETURN_GENERATED_KEYS);
